...
var Swiper = function (a, b) {
    ...
    function r(a) {
        if (H && C.swipeReset(), !b.onlyExternal && C.isTouched) {
            ...
            if (C.isMoved = !1, b.freeMode) {
                if (b.freeModeFluid) {
                    var h, i = 1e3 * b.momentumRatio, j = C.velocity * i, k = C.positions.current + j, l = !1,
    ...
    function u(a, c, d) {
        ...
        if (C.support.transitions || !b.DOMAnimation) C.setWrapperTranslate(a), C.setWrapperTransition(f); else {
            var h = C.getWrapperTranslate(), i = Math.ceil((a - h) / f * (1e3 / 60)), j = h > a ? "toNext" : "toPrev",
                k = "toNext" === j ? h > a : a > h;
    ...
    if (window.getComputedStyle || (window.getComputedStyle = function (a) {
        ...
        C.startAutoplay = function () {
            ...
            if (0 !== C.slides.length) {
                ...
                var a, c = "", d = "", e = "", f = C.slides.length, g = Math.floor(C.loopedSlides / f),
                    h = C.loopedSlides % f;
                for (a = 0; g * f > a; a++) {
                    var i = a;
                    if (a >= f) {
